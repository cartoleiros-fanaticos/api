...
function crossing() {
  ...
  async function enter() {
    ...
    try {
      ...
      const { data } = await api.get(`cruzamento?posicao_id=${filter.posicao_id.value}&ultimas_rodadas=${filter.ultimas_rodadas.value}&total=${filter.total.value}&tipo=media&temporada=${seasson}`);
  ...
  async function getData() {
    ...
    try {
      ...
      const { data } = await api.get(`cruzamento?tipo=media&temporada=${seasson}`);
